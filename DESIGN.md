# DESIGN.md: Awesome Digital Engineering

## Product

**Name:** Awesome Digital Engineering  
**Purpose:** Public-domain curated index of digital engineering transformation resources: digital thread, model-based definition (MBD), and the policy and standards that bind them.  
**Primary users:** Digital engineering practitioners (thread, MBD/PMI, STEP, policy).  
...
- Optional: simple monochrome diagram only if it earns space; default is typography + list  
- Icons sparse; mono text labels preferred  
- Open Graph: title + description; no mandatory social image for pilot
...
1. Existing project landing HTML/CSS  
...
```text
Files read:
- awesome-archimate DESIGN.md / DESIGN_BRIEF.md (family gold sample)
- styles/minimal-technical ranges reused via gold sample tokens
- patterns/progressive-disclosure and homepage-composition via gold sample
```
