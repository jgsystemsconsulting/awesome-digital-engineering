...
|---|---|---|---|---|
| Org catalogue (https://labs.jgsystemsconsulting.com/) | site entry | planned | Product page when labs catalogue covers awesome lists. | 2026-09-17 |
| GitHub About + topics + Release | configure_repo.sh + gh release | in progress | Description and topics set; v0.1.0 Release this pass. | 2026-09-17 |
| sindresorhus/awesome | PR | deferred | FAMILY step 6 after list depth and sweep history; follow awesome-sysml-v2 runbook. | 2026-09-17 |
